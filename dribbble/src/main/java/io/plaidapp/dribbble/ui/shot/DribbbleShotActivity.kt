...
class DribbbleShotActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val factory = provideViewModelFactory(applicationContext)
    ...
    private fun shareShot(shareInfo: ShareShotInfo) {
        ShareCompat.IntentBuilder.from(this)
            .setText(shareInfo.shareText)
            .setSubject(shareInfo.title)
            .setStream(shareInfo.imageUri)
            .setType(shareInfo.mimeType)
            .startChooser()
    }
