...
class DribbbleShotViewModelTest {
    ...
    private val getShareShotInfoUseCase = mock(GetShareShotInfoUseCase::class.java)
    ...
    fun shotShareClicked_sendsShareInfoEvent() {
        ...
        val expected = ShareShotInfo(uri, "Title", "Share Text", "Mime")
        Mockito.`when`(getShareShotInfoUseCase.invoke(any())).thenReturn(expected)
